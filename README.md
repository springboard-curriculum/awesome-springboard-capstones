...
| [Blog](https://learn.springboard.com/using-data-analytics-to-show-the-true-roi-of-residential-solar-investment/ ) | "Using Data Analytics to Show the True ROI of Residential Solar Investment" |
| [Blog](https://learn.springboard.com/what-does-data-analysis-suggest-about-the-link-between-environmental-pollution-and-systemic-racism-in-america/) | "What does data analysis suggeset about the link between environmental pollution and systematic racism in America?" |
| [Blog](https://learn.springboard.com/automating-image-keywording-using-deep-learning-neural-network/) | "Automating image keywording using deep learning neural networks" |
